...
private final Solenoid cannon_list[] = new Solenoid[4];
private final double MINIMUM_PRESSURE = 25.0;
    /**
    *
    */
    public Cannons() {
 ...
 addChild("compressor",compressor);
    ...
    public void fireCannon(int i) {
        if(!compressor.getPressureSwitchValue()) {
            ...
            System.out.println("Cannon not activated. System not fully pressurized.");
        }
    }
}

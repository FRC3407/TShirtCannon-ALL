...
public class Cannons extends SubsystemBase {
    ...
    */
    ...
    public void fireCannon(int num)
    {
        if(num == 0)
        {
    ...
    public void playHorn(boolean on)
    {
       airHorn.set(on);    
    }
}
